...
("1666", "Draw vectors involved in diffuse reflection and explain role of angles.", 10), 
("1705", "What is the basic approach to numeral integration?", 10), 
("1707", "What is a stack?", 10), 
("1709", "Which of Crosbys four absolutes apply to software testing? How/why?", 10), 
...
("825", "computer vision - image enhancement 
...
("830", "Describe inverse kinematics. When is inverse kinematics useful? Why?", 10), 
...
("989", "What are Crosbys four absolutes?", 10), 
...
("1699", "Which of Crosbys four absolutes of quality is most relevant to software testing?", 9.67), 
...
("1730", "What is the difference between procedural programming and event driven programming? 
deterministic?", 9.67), 
...
("168", "types of searching in AI applications
What are some questions that must be answer in the creation of Physical Data FlowDiagrams?", 9.5), 
...
("1672", "What is meant by 2s complement representation and why is it used?", 9.33), 
("1677", "", 9.33), 
("1696", "What is the basic idea of numerical integration?", 9.33), 
...
("1613", "_____ programs are planned special efforts to recruit  hire  and promote women and members of minority groups. 
A. Reverse discrimination
B. Affirmative action
C. Privacy
D. Discrimination
E. Americans with disabilities", 9.33), 
...
("75", "Give examples of problem domains that could easily be represented in a rule-basedexpert system  and ones that couldnt. Explain why or why not.", 9), 
("475", "What are some of the components of software quality assurance?", 9), 
("628", "What does RISC stand for and why does it exist?", 9), 
("831", "example of a simulation that would be continous
example of a simulation that would be discrete", 9), 
...
("1430", "\"Follow up - NP - \"\"cant be done in polynomial time\"\" - I disagree\"", 9), 
("1466", "", 9), 
("1482", "What is the concept of a divide and conquer algorithm? Give an example.", 9), 
("1487", "What are the various levels of Maslovs hierarchy?", 9), 
...
("1549", "from ENP332: In a control system  a system has an input x  output y  a forward gain G  and a negative feedback gain H. draw a block diagram 
representing this system  and express the transfer function TF of the 
system y/x as a function of G and H.", 9), 
...
("1610", "Lets say that you wanted to improve performance of a C program. What are the best approaches? What should you try doing first? Would it be worth re-writing any part of the program in assembly language?", 9), 
...
("1630", "How can a project manager ensure team meetings are productive?", 8.67), 
("1684", "How do you perform usability testing?", 8.67), 
("1689", "\"COS 314: What are the ideas in the web philosophy of \"\"Dont make me think\"\"?\"", 8.67), 
("1690", "How does copyright affect your profession on a day-to-day basis?", 8.67), 
...
("1152", "Create a binary search tree by inserting the following items in the order given:
8 2 4 3 7 5 9 1 6", 8.65), 
...
("1603", "What is KT decision analysis?
Give an example of when it would be used.", 8.5), 
...
("298", "How does a hash function work? [follow on] Why go to the trouble of hashing?", 8.33), 
...
("309", "What is Dijkstras algorithm used for? [follow on] How does it work?", 8.33), 
...
("1327", "Show that the sequence 1  -1!  2! -3!  4!  . . .   (-1)n n!  . . . for n >= 0  satisfies the recurrence relation 
sk = (-k ) sk-1", 8.33), 
...
("1211", "If you saw the following performance data for an algorithm  what would be its complexity?
N time(N)
1024 1.00
2048 2.15
4096 4.7", 8.17), 
...
("827", "simulation - continous vs discrete sim
example of each", 8), 
...
("679", "What is an abstract base class? Why would someone use an abstract base class?
How do you search for information in a graph?", 8), 
...
("1332", "Assume a floating-point representation that uses the following characteristics:
1. 4-bit (excess 7) exponent
2. 3-bit significand
3. 8-bit total size
What is the representation of 4.75?", 8), 
("1360", "What is a Hamiltonian cycle?", 8), 
("1385", "How is animtion in Flash different than animation in Maya?", 8), 
("1443", "image processing - what is a kernel? How is it used?", 8), 
...
("633", "Describe twos complement representation of negative binary numbers.", 7.5), 
...
("9", "What are the 5 levels in Maslows Needs Hierarchy?", 7.33), 
...
("1265", "Web site design - how will artists and 
\"\"\"geeks\"\" look at the process differently?\"", 7.33), 
...
("1355", "Solve the following recurrence relation:
C(n) = n + c(n-1)", 7.17), 
...
("1322", "How would the DOM look for the following web page:
<html>
<head>
<title>Example page</title>
</head>
<body>
<p>This is a short web page.</p>
</body>
</html>", 7.1), 
...
("1593", "What is meant by the terms:
memory leak
garbage collection", 7), 
("1210", "What is the exact operation count and big-oh complexity for:
for i = 1 to n
for j = 1 to n-1
do_some_work O(1)", 7), 
("1715", "Hash table - purpose?", 7), 
("1750", "What is the thevenin equivalent to the given circuit?
What is the load line?", 7), 
...
("902", "Construct a minimal circuit for xy zw yz wx.", 6.67), 
...
("698", "What does Prims algorithm do? How does it work?", 6.67), 
...
("885", "What is Djikstras algorithm?", 6), 
...
("1413", "The transfer function of a filter is H(s)=10/(1 s/100).
Plot the freq. response (Bode plot)  mag and phase vs freq. (dB vs log(w)  and phase vs log(w)).", 6), 
...
("1118", "In Java  what are the differences between a class  an abstract class  and an interface?
Why are interfaces important?", 5.72), 
...
("1049", "Describe the principle of operation of a transformer  and describe which of Maxwells equations bare upon its operation.", 5), 
...
("1194", "There are four primary advantages of group decision making. Which of the following is not one of those four:
A. Better decisions
B. Groupthink
C. More alternatives
D. Morale
...
("1756", "Describe qualitatively and quantitatively (as much as possible) the given resistor/transistor circuit. Sweep the input voltage from 0 to 5V and show the output voltage on a graph.
Describe the large signal analysis of the transistor in the circuit.
etc.", 4.67), 
...
("1651", "In the world of DBs  what are indices  why are they used  and is there any cost to their use?", 3.33), 
...
("1395", "Build a binary search tree with the following input (in order):
8 7 9 6 5 10 11 4 3 12", 3.33), 
...
("1196", "Solve the recurrence relation for the given initial condition:
an = 5 n3 an-1  a1 = 1 for n â‰¥ 2", 2.67), 
...
("1054", "What is DeMorgans Law?", 2.67), 
...
("1228", "What is the recurrence relation for the following algorithm:
X(n)
if n > 0
do_some_work // O(1)
X(n-1)
...
("1564", "from ENP332/331: What is meant by finding the complete solution of an LTI system? Explain how one finds this solution?", 2), 
...
("1214", "Solve the recurrence relation for the given initial conditions:
an = 18 an-1 - 81 an-2  a1 = 9  a2 = 81 for n â‰¥ 3", 0.5), 
...
("1619", "COS340", "\"There are a variety of techniques that can be applied to the problem of estimation in software engineering. Often it is based on past experience while performing similar tasks. The project can be broken up into sub-categories and each one can be estimated individually. The Wideband Delphi estimation method is a consensus-based technique for estimating effort. It derives from the Delphi method which was developed in the 1950-1960s at the RAND Corporation as a forecasting tool. It has since been adapted across many industries to estimate many kinds of tasks ranging from statistical data collection results to sales and marketing forecasts. (see wikipedia \"\"Wideband delphi\"\" or \"\"Cost estimation in software engineering\"\" for more information on this topic)\"", "SRW"), 
("1628", "COS350", "", NULL), 
("1631", "COS425", "Compositing is like the post production when you make it look pretty. For example you could add fog color balance etc. Its useful in animation because it allows you to layer images and create effects that you cant do while you animate. It can also be useful for reducing the amount of time to create certain effects.", "AC/DKK"), 
("1642", "COS265", "\"Event handlers are pieces of code that \"\"fire\"\" when an event happens. For instance if a user selects a checkbox there is code to handle that checkbox being clicked. The programmer does not control when or if events happens but they control what happens when the event does happen. .NET is the windows programming model and is heavily based in events.\"", "AAC"), 
...
("1657", "COS284", "The attacker overwrites the return address of a function with the address of some malicious code. When function execution ends execution will jump to the area of malicious code that was earlier injected.", "SRW"), 
("1661", "COS265", "It will take 80 units of time", "SRW"), 
("1666", "COS351", "Diffuse reflection is caused by a ridged surface so the light bounces off at different angles creating a lot of different normals.", NULL), 
("1705", "MAT151", "Integrals can be used the find the area under a curve and the approach is essentially the reverse of finding the derivative (or rate of change). To find the exact answer one may use the fundamental theorem of calculus: derivative=change in x/change in time which can be rearranged to solve for change in x or change in time as needed. Also helpful is the second fundamental theorem of calculus which states: if f is integrable on [ab] then the integral of f from a to b is f(a) -f(b) ", "SRW"), 
...
("1709", "SYS390", " The performance standard is zero defects—a commitment to conform to requirements each and every time. This applies to software testing because as a tester we are trying to remove all defects with the code. ", NULL), 
("1710", "SYS401", "A linear program involves an objective function that needs to be optimized and a set of constraints that must be adhered to. Most linear programs can be solved using the simplex method but 2d or 3d problems can be solved graphically by plotting the objective function and all of the constraints determining the feasible region and then moving the objective function to critical point in the feasible region that optimizes the solution.", "SRW"), 
("1719", "COS320", "", NULL), 
("1724", "COS351", "Use a filter to determine the rate of change in intensity of pixels. The areas with higher values will generally be where edges are.", "SRW"), 
("1725", "COS265", "a finite state machine with two tapes: an input tape and an output tape. Nobody in senior capstone has taken NLP yet.", "SRW"), 
("1726", "COS265", "Running time grows log n.", NULL), 
("1727", "COS265", "Breadth first searches will examin all nodes/data entries on the current level before accessing lower levels. Depth first searches will explore as for as possible down one branch before backtracking and accessing another branch.", "DKK"), 
("1728", "IAS330", "No.", NULL), 
("1729", NULL, "", NULL), 
("1731", NULL, "\"Data is organized by looking at the euclidean distance between points in order to group data together with its \"\"nearest neighbors\"\". For a simple example a NN solution to the traveling salesman problem would involve always choosing the next city to be the city that is closest to the current city.\"", "SRW"), 
...
("70", "SYS352", "", NULL), 
("830", "COS425", " refers to the use of the kinematics equations of a robot to determine the joint parameters that provide a desired position of the end-effector. Example: if you move the elbow of a robot up the hand should move with it. It is useful when you are creating models that have movements that depend on joints. It eliminates a lot of animation work.", NULL), 
("117", "SYS390", "ERDs illustrate the logical structure of a database. A data modeling technique used in software engineering to produce a conceptual data model of a information system. A box with student and a box with classes with a one to many relationship. ", NULL), 
("608", "COS381", "Hexadecimal: BD Octal: 275", NULL), 
("843", NULL, "a", "SRW"), 
("844", "COS425", "Keyframe animation", NULL), 
("550", "COS350", "Texture mapping is where you place a texture over an object. It is desirable because it can create more realistic object.", NULL), 
("851", "SYS394", "a  business to business application is an application that has been designed by a business for a business", NULL), 
("853", "SYS390", "Entity Relationship Diagram is a diagram of a database design", "AK"), 
("854", "COS265", "Bubble sort FTW! Worst case performance  O(n^2)      \nBest case performance        O (n)\nAverage case performance        O (n^2)       ", NULL), 
("30", "SYS200", "", NULL), 
("862", "SYS214", "Accessibility is features that allow disabled persons to use a device or program.", NULL), 
("863", "SYS101", "Data encryption Data backup Access controls Input validation and Data validation. Primary keys to maintain entity integrity and foreign keys to maintain referential integrity", "NJC"), 
("865", "COS320", "", NULL), 
("405", "COS320", "", NULL), 
("879", NULL, "", NULL), 
("886", NULL, "", NULL), 
...
("918", NULL, "", NULL), 
("924", "COS351", "", NULL), 
("230", "COS240", "In the past .NET was the most popular language. Currently Java is probably the most popular language. ", NULL), 
("945", "COS121", "Binary trees are pre- in- or post- order.", "MCW"), 
...
("254", "COS250", "prefix notation: + 3 4 infix notation: 3 + 4 postfix: 3 4 + ", NULL), 
("957", "COS284", "1-May", "SRW"), 
("246", "COS250", "a method is written under the assumption that certain things are true about the environment: these are called pre-conditions. A post-condition indicates the changes made to the state of the world by invoking a method.", NULL), 
...
("977", "COS284", "A page table is the data structure used by a virtual memory system in a computer operating system to store the mapping between virtual addresses and physical addresses. Virtual addresses are those unique to the accessing process. Physical addresses are those unique to the hardware i.e. RAM.", "AK"), 
("959", "COS284", "for single precision 32-bit 01000000 10011000 00000000 00000000", NULL), 
("1033", "COS265", "A hash is a way of storing data that allows for constant time (O(1)) searching of data.  Collisions are problems", "BN"), 
("1034", "COS265", "A partially ordered data structure is a data structure whose data is partially ordered meaning that only some of the data is in random order.", NULL), 
("1036", NULL, "Normalizing eliminates redundant data utilizes space efficiently and reduces update errors. Joins are expensive sometimes its not necessary normalized sql queries can be extensive and if youre building a quick and dirty prototype it shouldnt be difficult. ", NULL), 
("1042", NULL, "", NULL), 
("1043", NULL, "", NULL), 
("269", "COS250", "\"A typical solution when a collision occurs is to iterate the index until one becomes available. the next time you search for that value you will start from the given hash key and iterate the index (or \"\"probe\"\") until you find the value you are looking for or an empty index (meaning the value does not exist). Other solutions included associating a linked list or array with each index of the hash to hold values that collided.\"", "DKK"), 
("1106", "SYS394", "Longest sequence of activities in a project plan which must be completed on time for the project to complete on due date", NULL), 
("1245", "SYS394", "Prepare decision statement\n- includes not only the desired result but also the action required\nDefine:\n- Strategic requirements - must haves \n- Operational objectives - want to haves \n- Restraints - limits in the system\nRank the objectives and assign relative weights\nList alternatives- Generate as many potential courses of action as possible whether immediately feasible or not\nScore each alternative- Firstly eliminate any alternative that does not fit the must haves. - Going through each alternative one by one rate it against each Want on a scale of 1 to 10. - Next multiply the weight of the objective by the satisfaction score to come up with the weighted score.\nChoose the top two or three alternatives and consider potential problems or negative effects of each \nConsider each alternative against all of the negative effects - One at a time again rate alternatives against adverse effects scoring for probability and significance\nAnalyze the weighted score versus the adversity rating for each and choose the high-scoring one. \nConsider the winning option against each negative consequence and suggest a plan of action to minimize the adverse effects.", "AK"), 
...
("1454", NULL, "\"Parsing often means \"\"perform syntax analysis\"\" on a program or a text.\"", NULL), 
...
("1521", NULL, "An abstract data type is a model for organizing data which is defined conceptually but may be implemented (coded?) many different ways. examples is a stack which must have a push (way to fill the stack) and pop (way to empty the stack) operation but may be written any number of ways (array linked list etc.)", "DKK"), 
("1562", NULL, "A greedy algorithm is an algorithm that follows the problem solving heuristic of making the locally optimal choice at each stage with the hope of finding a global optimum. In many problems a greedy strategy does not in general produce an optimal solution but nonetheless a greedy heuristic may yield locally optimal solutions that approximate a global optimal solution in a reasonable time.", "AK"), 
...
("1679", NULL, "1. Internal - processor registers and cache. 2. Main - the system RAM and controller cards 3. On-line mass storage - secondary storage 4. off-line bulk storage - tertiary and off-line storage ", NULL), 
("1681", NULL, "", NULL), 
("1699", "SYS101", "The System of Quality is Prevention", "SRW"), 
("1700", "SYS394", "Scrum is an iterative and incremental agile software development method for managing software projects and product or application development. Scrum has not only reinforced the interest in project management but also challenged the conventional ideas about such management. Scrum focuses on project management institutions where it is difficult to plan ahead. It represents a radically new approach for planning and managing projects bringing decision-making authority to the level of operation properties and certainties. http://www.youtube.com/watch?v=Q5k7a9YEoUI", "JB"), 
("1716", "MAT151", "", NULL), 
...
("1026", "COS230", "Technology in the future. Because it doesnt exist.", NULL), 
("172", "SYS394", "", NULL), 
("410", "COS320", "", NULL), 
("1038", "COS351", "Noise removal through opening and then closing the image (Opening is applying kernel that grabs the darkest (smallest) surrounding pixel and closing is applying kernel that grabs the lightest (largest) surrounding pixel) or through Gaussian filter.", "DKK"), 
("1067", "SYS390", "Conformance to requirements", "AK"), 
("507", "COS341", "SELECT FROM and WHERE. SELECT is used to specify which fields you would like returned. FROM specifies the table from which you are pulling data.  WHERE specifies any conditions in order to filter the results of the query. ", "AK"), 
("1336", "COS121", "A bunch of nodes that each contain a payload and a pointer to the next node", "SRW"), 
("1358", "COS264", "You can search for similar types of text such as valid email rather than looking for a specific email address. You can make large repetitive changes over a document with more specificity than you can with text searching. You have to know the content of the document to construct a proper regex.", "AAC"), 
("1359", "MAT151", "", NULL), 
("1307", "COS284", "", NULL), 
("1374", "IAS330", "", NULL), 
("1516", "COS265", "To facilitate quick traversal of the tree.", "AD"), 
("1523", "COS435", "Yes", "SRW"), 
("1528", NULL, "The public key is made publicly available and can be used to encode messages to be sent to the owner of the key.  The private key is kept secret and can then be used to get the original message back by the receiver.", "BN"), 
("1333", "COS340", "Test-driven development is a software development process that relies on the repetition of a very short development cycle: first the developer writes an (initially failing) automated test case that defines a desired improvement or new function  then produces the minimum amount of code to pass that test and finally refactors the new code to acceptable standards. ", NULL), 
("1121", "COS284", "The decimal value is 92 and the hex value is 0x5c", "AK"), 
("1271", "COS381", "When encountering a branch in the code (for example an if statement)  the processor predicts which branch will be followed when the execution reaches that point and begin to fetch and decode the instructions along that branch in the pipeline.  If the guess is correct  then clockcycles will have been saved.", "BN"), 
("1624", "SYS394", "In a system response table the client specifics requirements by stating what the new system is expected to do when a certain input or event occurs. ", "AAC"), 
...
("826", "COS280", "", NULL), 
("81", "SYS352", "Refraction is used to prevent duplicate rule activations from the same set of known facts.", "BN"), 
("837", "COS264", "Scalar  List  and Hash", "AAC"), 
("314", "COS252", "Draw a picture of a tree. Literally.", NULL), 
("305", "COS252", "", NULL), 
("233", "COS240", "A method is like a function  that are built into objects. stringObject.substring()", NULL), 
...
("168", "SYS394", "Systems analysis (ISA) focuses on logical  implementation-independent aspects of a system (i.e.  requirements).Systems design (ISD) deals with the physical or implementation-dependent aspects of a system (i.e.  technical specs)", NULL), 
("955", NULL, "", NULL), 
("23", "SYS290", "An ERD is comprised of entities and relationships hence entity relationship diagram.  Entities are basically the tables in your database and relationships are the connectors between entities and formed via primary and foreign keys. Attributes turn into table columns. ", "AK"), 
("1202", NULL, "", NULL), 
("1304", NULL, "", NULL), 
...
("1452", "COS380", "", NULL), 
("1589", NULL, "", NULL), 
("1590", NULL, "\"When RAM is insufficient while running applications simultaneously  a computer looks at how much of that memory hasnt been used recently by an application and copies that memory to the hard drive. When switching between applications  the now virtual memory exchanges the memory from the hard disk to the RAM allowing supposed \"\"unlimited\"\" RAM.\"", "MCW"), 
("1605", NULL, "", NULL), 
("1255", "COS425", "You have to put motion constraints on models so that they animate naturally. The skeletons are used to make joints. The degrees of freedom is how many angles the joint can move. For example  if youre animating an elbow  you want to make sure the elbow cant bend backwards. ", "AAC"), 
("1638", "COS425", "Key frames are used to begin and end sequences of animation - aka begin and end smooth transitions.", "AS"), 
("1552", "SYS411", "Crossover describes how solutions are interwoven in order to produce new solutions. The crossover method and crossover rate will affect how much sharing takes place between solutions  while the mutation operator and the mutation rate will affect the amount of new genes that are introduce into the population.", "SRW"), 
("1668", "SYS411", "Start with the rules and facts and continue to make inferences until a goal is reached.", "SRW"), 
("1672", "COS284", "2s complement will switch the bits from 0s to 1s and 1s to 0s. And then add one to the smallest bit. This allows for subtraction of two numbers using addition. 2s compliment gives us the opposit sign for any number.", NULL), 
("1677", "MAT151", "", NULL), 
("1696", "IAS330", "Beating them with a stick.", NULL), 
...
("87", "SYS352", "", NULL), 
("127", "SYS390", "Systems analysis is the objective breakdown of the business rules of a particular organization to determine the best workflow and system to meet the rules.  Systems design is the implementation of the system that best (hopefully) meets the rules.", "AS"), 
("986", NULL, "", NULL), 
("244", "COS250", "An ADT consists of data elements and methods that operate on that data. The user can access the operations  but cannot access the internal structure of the data elements.", NULL), 
("1017", NULL, "Appropriate technology (AT) is technology that is designed with special consideration to the environmental  ethical  cultural  social  political  and economical aspects of the community it is intended for. You should care about it because that is what you should be designing.", "AAC"), 
("1029", NULL, "", NULL), 
("453", "COS331", "", NULL), 
("1105", NULL, "", NULL), 
...
("1259", NULL, "CSS - Rules and structures that govern the look and feel of html  xml  xhtml  etc..", "AS"), 
("1289", "COS340", "", NULL), 
("1329", NULL, "Asynchronous Javascript and XML. Its not a language but a combination of languages that allows a webpage to send and receive data without reloading the entire page. JSON is often used instead of XML.", "DKK"), 
("1485", NULL, "\"The browser makes a connection with the specified server and sends it a request containing an \"\"action\"\" (GET  POST  DELETE  etc). The server then replies with a header and message (typically html code).\"", "DKK"), 
("1527", "COS265", "A Java Interface is set of methods that a class must provide and an optional set of constants. Interfaces are used to give similarities to various class types without them having any relationship.", "MCW"), 
("1563", NULL, "", NULL), 
("1611", NULL, "", NULL), 
("1613", "IAS330", "", NULL), 
...
("1122", "COS310", "Acquire mountain dew. Start late at night. Then beginning reading  very carefully.", "AAC"), 
("613", "COS381", "", NULL), 
("1420", "COS382", "The main differences between compiling and interpreting is that compiling forces all pre-processing at once  while interpreted PL/SQL is done line-at-a-time:", "AAC"), 
("1132", "COS381", "", NULL), 
...
("1153", "COS240", "The VB.NET debugger works like other debuggers. You can set breakpoints and step through code. You can hover over variables to see what they contain. Code can be edited as it is debugged. can be a source-level debugger and machine-level debugger. ", "AAC"), 
("1416", "COS340", "", NULL), 
("1162", "COS331", "", NULL), 
("1170", "SYS352", "", NULL), 
("1637", NULL, "", NULL), 
("1639", NULL, "If they really can  then heck yes. Otherwise  definitely not. Theyre lying. ", "AAC"), 
("1129", "COS340", "\"Revision control  also known as version control and source  is the management of changes to documents  computer programs  large web sites  and other collections of information. Changes are usually identified by a number or letter code  termed the \"\"revision number\"\"  \"\"revision level\"\"  or simply \"\"revision\"\". For example  an initial set of files is \"\"revision 1\"\". When the first change is made  the resulting set is \"\"revision 2\"\"  and so on. Each revision is associated with a timestamp and the person making the change. Revisions can be compared  restored  and with some types of files  merged.\"", NULL), 
("1713", "COS264", "Model-View-Controller --- a software design pattern that separates the representation of the information from the users interaction with it.", "AS"), 
("1269", "COS340", "", NULL), 
("1721", NULL, "", NULL), 
("1753", NULL, "", NULL), 
("819", "COS425", "Flash is dying.  And flash is 2d animation  maya is 3d (along with modeling)", "AS"), 
("251", "COS250", "Quicksort. It is a divide and conquer algorithm which recursively sorts smaller and smaller lists.", "AAC"), 
("75", "SYS352", "", NULL), 
("475", "COS340", "", NULL), 
("628", "COS381", "", NULL), 
("831", NULL, "", NULL), 
("832", NULL, "Regular expressions are a concise and flexible way to match text.  For example  to match an email address (where the user only typed an email address).... /^[A-Z0-9._%+-]+@[A-Z0-9.-]+\.[A-Z]{2 4}$/", "AS"), 
("151", "SYS390", "", NULL), 
("847", NULL, "", NULL), 
("16", "SYS200", "", NULL), 
("856", NULL, "", NULL), 
...
("866", "COS121", "Data abstraction  encapsulation  inheritance  polymorphism  and modularity (among others)", "AS"), 
("237", "COS240", "\"In Visual Studio there is a toolbox named \"\"Menus & Toolbars\"\".  Open that toolbox and select the control name \"\"MenuStrip\"\".  Drag one of those onto the form near the top of your form.  It will dock to the top of the form.  You can either type menus and sub items  or you can right-click the menu and select \"\"Insert Standard Items\"\".  The latter will insert the normal menus like \"\"File\"\" \"\"Edit\"\" \"", "AS"), 
("887", NULL, "", NULL), 
("652", "COS381", "", NULL), 
("888", NULL, "", NULL), 
("894", NULL, "", NULL), 
...
("919", NULL, "", NULL), 
("920", NULL, "", NULL), 
("241", "COS250", "\"An Object is the instance of a class and a Class is a structure that contains variables and operations to be performed. For example an object \"\"Horse\"\" might be an instance of the class \"\"Animals\"\". Class \"\"Animals\"\" might contain the variables \"\"Name\"\"  Species\"\"  \"\"Color\"\" and the operations eatTheFood()  sleepInBed() and avoidDeath(). Example of Queue: class Queue{ var data  function push()  function pop();} var movieLine = new Queue;\"", "DKK"), 
("933", NULL, "ADV - Object Oriented naturally  easy to use  multithreaded --- DIS - Single language paradigm  slower (than C++)  look and feel not so nice", "AS"), 
("281", "COS250", "[I have an answer for this  but its an image  so Im not sure what to do with it]", "BN"), 
("506", "COS341", "", NULL), 
("941", "SYS214", "Feedback plays an important role in human-computer interaction. It provides the user with evidence of closure  thus satisfying the communication expectations that users have when engaging in a dialogue.", "AS"), 
("400", "COS320", "Binary trees have at most 2 leaves per node  n-ary trees have at most n leaves per node.", "SRW"), 
("951", NULL, "Unit testing is testing individual sets of data  units  to see if they are fit to be used.", NULL), 
("985", NULL, "", NULL), 
...
("520", "COS341", "", NULL), 
("169", "SYS394", "", NULL), 
("1019", "SYS214", "So we can better understand how to design software and products that are easily figured out and used by people.", "AS"), 
("386", "COS320", "A directed acyclic graph in which each node has at most two branches.", "SRW"), 
("382", "COS320", "\"Turing was a British mathematician  logician  cryptanalyst  and computer scientist.  He gave a formalization of the concepts of \"\"algorithm\"\" and \"\"computation\"\" with the Turing machine  which can be considered a model of a general purpose computer. \"", "AS"), 
...
("1086", NULL, "", NULL), 
("1088", "SYS214", "\"the term traditionally refers to the development of sites that are accessible to \"\"all\"\" users who may want to access them.  (That way all users can access!)\"", NULL), 
...
("1429", NULL, "", NULL), 
("1430", NULL, "", NULL), 
("1466", "SYS390", "\"Prepare decision statement- includes not only the desired result but also the action requiredDefine:- Strategic requirements - must haves - Operational objectives - want to haves - Restraints - limits in the systemRank the objectives and assign relative weightsList alternatives- Generate as many potential courses of action as possible whether immediately feasible or notScore each alternative- Firstly  eliminate any alternative that does not fit the must haves. - Going through each alternative one by one  rate it against each Want on a scale of 1 to 10. - Next  multiply the weight of the objective by the satisfaction score to come up with the weighted score.Choose the top two or three alternatives and consider potential problems or negative effects of each Consider each alternative against all of the negative effects - One at a time again  rate alternatives against adverse effects  scoring for probability and significanceAnalyze the weighted score versus the adversity rating for each and choose the high-scoring one. Consider the winning option against each negative consequence and suggest a plan of action to minimize the adverse effects.\"", "AK"), 
("1482", NULL, "Divide and conquer algorithms recursively break down the problem into sub-problems that are simpler to solve until it becomes simple enough to solve directly. The sub-problems are then combined to solve the original problem. For example a binary search", "DKK"), 
("1487", NULL, "", NULL), 
("1510", NULL, "\"In computing  a regular expression provides a concise and flexible means to \"\"match\"\" (specify and recognize) strings of text  such as particular characters  words  or patterns of characters. Common abbreviations for \"\"regular expression\"\" include regex and regexp.\"", "AK"), 
("1518", NULL, "", NULL), 
("1522", NULL, "", NULL), 
("1540", NULL, "", NULL), 
("1348", "MAT215", "", NULL), 
...
("1315", "SYS390", "", NULL), 
("1610", NULL, "", NULL), 
("1117", "COS264", "All programming languages will have basic input and output  ways of representing data (ints  floats  strings  etc.) and ways to compare values (greater then  equal to  less then). I would look for these basic ideas in the languages documentation...to the Internets! ", "DKK"), 
("200", "SYS402", "", NULL), 
("272", "COS250", "A binary search tree is a data structure that has two child nodes for each parent node  a root node  and leaf nodes. ", NULL), 
("1137", "COS425", "Particles and gases are different than objects like walls and tables because they have no definite shape or boundaries - they have no vertices.", "AS"), 
("509", "COS341", "The primary key is the unique identifier of a database table.  The foreign key is the identifier for another table that ties into the current one.", "AS"), 
("502", "COS341", "", NULL), 
("37", "SYS310", "", NULL), 
("1357", "COS381", "", NULL), 
("348", "COS264", "", NULL), 
...
("1425", "SYS352", "", NULL), 
("1630", "SYS101", "They analyze business processes according to the business rules and reform the process as necessary to make it more efficient.", "AS"), 
("1684", "SYS214", "Brief the user - find out relevant preliminary data about the tester - walk them through a series of questions that if completed would accomplish specific tasks.", "AS"), 
("1689", "SYS214", "This basically means that if you design a website that is easy and quick to use and navigate through then the user doesnt mind looking through your site. But if the site is hard to navigate through then the user will probably leave the site and will not be interested even if you site is really important.", "NJC"), 
("1690", NULL, "We have to work around annoying laws.", NULL), 
("1703", NULL, "", NULL), 
("1723", NULL, "\"Deontological ethics or deontology (from Greek deon  \"\"obligation  duty\"\"; and -logia) is the normative ethical position that judges the morality of an action based on the actions adherence to a rule or rules. It is sometimes described as \"\"duty\"\" or \"\"obligation\"\" or \"\"rule\"\" -based ethics  because rules \"\"bind you to your duty\"\".\"", "AK"), 
("926", NULL, "", NULL), 
("928", NULL, "", NULL), 
("932", NULL, "", NULL), 
...
("171", "SYS394", "", NULL), 
("270", "COS250", "The depth of a node is the length from the root to a any given node. The height refers to the length from root to deepest node. The degree refers to whether or not a given node has a left and/or right edge/side. The degree of a node can be in-degree or out-degree. In-degree meaning it has a left and right; whereas  out-degree having either left or right.", "MCW"), 
("714", "COS250", "A hash function links larger data sets to smaller data sets of fixed length. Hash coding makes databases easier to look up and finding similarities in large amounts of data.", "MCW"), 
("609", "COS381", "100111011  315", "SRW"), 
("153", "SYS390", "", NULL), 
("1055", "COS265", "A greedy algorithm is an algorithm that follows the problem solving heuristic of making the locally optimal choice at each stage with the hope of finding a global optimum. In many problems  a greedy strategy does not in general produce an optimal solution  but nonetheless a greedy heuristic may yield locally optimal solutions that approximate a global optimal solution in a reasonable time.", "AS"), 
("1079", "COS265", "Yes", NULL), 
("1103", NULL, "It executes in the browser; it is a client-side scripting language. Some common uses are to dynamically create  delete  or change items on a webpage.", NULL), 
("1108", NULL, "", NULL), 
("1189", "COS331", "", NULL), 
("1213", "COS284", "", NULL), 
("1242", NULL, "", NULL), 
("1247", NULL, "", NULL), 
("1350", NULL, "", NULL), 
("1396", "COS264", "I dont know... I cant see the board.  Aka  one item encapsulated in another in another... or a bunch of nested divs.", "AS"), 
("1470", NULL, "", NULL), 
("1354", "COS310", "Google it!", "AS"), 
("1560", "SYS411", "", NULL), 
("1438", "COS381", "", NULL), 
("1581", NULL, "", NULL), 
("1191", "COS340", "", NULL), 
("1604", NULL, "", NULL), 
("1609", NULL, "", NULL), 
("1335", "SYS390", "Successful systems analysis requires knowing the business rules you have to conform to.  You need to know what the business is trying to accomplish.", "AS"), 
("1152", "COS121", "1", "SRW"), 
("1227", "COS264", "", NULL), 
("1147", "SYS392", "", NULL), 
("1119", "COS265", "", NULL), 
...
("1146", "SYS392", "", NULL), 
("1751", NULL, "", NULL), 
("530", "COS350", "Rendering is the process of generating an image from a 3d model or models using computer software and hardware.", "AS"), 
("406", "COS320", "", NULL), 
("828", NULL, "", NULL), 
("527", "COS350", "", NULL), 
("5", "IAS330", "", NULL), 
...
("1096", "COS425", "One key frame is set at the time where the animation begins... the object is moved to its final position... the last key frame is set at the time the animation ends... the software takes care of the middle.", "AS"), 
("1205", NULL, "", NULL), 
("1187", "COS320", "", NULL), 
("1297", NULL, "", NULL), 
("1295", "ENP352", "", NULL), 
("1298", NULL, "", NULL), 
("1432", NULL, "A greedy algorithm is an algorithm that follows the problem solving heuristic of making the locally optimal choice at each stage with the hope of finding a global optimum. In many problems  a greedy strategy does not in general produce an optimal solution  but nonetheless a greedy heuristic may yield locally optimal solutions that approximate a global optimal solution in a reasonable time.", "AK"), 
("1445", NULL, "", NULL), 
("1456", NULL, "Never.", "AS"), 
("1509", NULL, "", NULL), 
("1538", NULL, "", NULL), 
...
("1591", NULL, "", NULL), 
("1592", NULL, "", NULL), 
("1603", NULL, "Separation of musts and wants of a project and comparing all candidates against them", "AS"), 
("1144", "SYS390", "", NULL), 
("1308", "COS314", "", NULL), 
("1159", "COS314", "", NULL), 
("1123", "COS310", "", NULL), 
("258", "COS250", "A linked list is a data structure consisting of a sequence of nodes containing data and a reference to the next node in sequence. Because of its simplicity  it can be used to implement stack  queues  etc. of other abstract data type.", "MCW"), 
("73", "SYS352", "", NULL), 
("1266", "COS265", "", NULL), 
("1114", "COS240", "", NULL), 
("1667", NULL, "", NULL), 
("234", "COS240", "", NULL), 
("298", "COS252", "\"An input value is run through a hash function which returns an index into a hash table.The input value is stored or looked for at the indexed position in the hash table.If storing and something already exists at that location  a \"\"collision\"\" occurs andmust be resolved.If searching and the input is not found  additional search must be performed.Why - compresses storage required and minimizes search timeQUESTION:What is the difference between permutations and combinations?\"", "AAC"), 
("243", "COS250", "Three distinct characteristics are 1) recursion  2) encapsulation  3) and object inheritance.", "MCW"), 
("260", "COS250", "A major advantage of linked lists over other abstract data types is its ability to add or remove data without reallocating or reorganizing data elements like in a stack or array.", "MCW"), 
("294", "COS252", "", NULL), 
...
("1327", "MAT215", "", NULL), 
("1362", NULL, "", NULL), 
("1384", NULL, "If they want speed  good design  and usability go with HTML.  If you want cheesy animations or stupid web games  go with flash.", "AS"), 
("1471", NULL, "", NULL), 
("1472", NULL, "Python", NULL), 
("1475", NULL, "", NULL), 
("1477", NULL, "", NULL), 
("1484", NULL, "", NULL), 
("1615", NULL, "In computer science  an abstract data type (ADT) is a mathematical model for a certain class of data structures that have similar behavior; or for certain data types of one or more programming languages that have similar semantics. An abstract data type is defined indirectly  only by the operations that may be performed on it and by mathematical constraints on the effects (and possibly cost) of those operations.", "AK"), 
("1226", "COS264", "Using $_SERVER[<param>] given a particular parameter will give you information from a person IP access point to password authentication.", "MCW"), 
("1158", "COS314", "", NULL), 
("337", "COS264", "", NULL), 
("463", "COS340", "", NULL), 
("1165", "COS340", "", NULL), 
("383", "COS320", "", NULL), 
("257", "COS250", "\"An array is a data structure which can be set to a set amount and position in memory for storing data. Usually a list or \"\"string\"\" of characters are stored by individual letters in an array.\"", "MCW"), 
("1216", "SYS390", "\"Situation Appraisal is a formal method whereby a manager  or an individual  sets time aside to look at current and future realities.\n1. Identify Concerns 2. Set Priority 3. Plan Next Steps 4. Plan involvement Its purpose in system development methodology is to access a situation so that you can make decisions based a firm understanding of the situation. \"", "AK"), 
("1211", "COS265", "", NULL), 
("1178", "COS264", "", NULL), 
("353", "COS264", "", NULL), 
("1112", "COS121", "", NULL), 
...
("1177", "COS264", "", NULL), 
("1621", NULL, "", NULL), 
("1629", "SYS310", "No sales tax.  That  and cheaper prices than anyone else  especially brick/mortar stores.", "AS"), 
("1732", NULL, "", NULL), 
("1754", NULL, "", NULL), 
("812", NULL, "", NULL), 
("821", NULL, "", NULL), 
("275", "COS250", "", NULL), 
("827", NULL, "", NULL), 
("289", "COS252", "\"In mathematics  a recurrence relation is an equation that recursively defines a sequence  once one or more initial terms are given: each further term of the sequence is defined as a function of the preceding terms.\nThe term difference equation sometimes (and for the purposes of this article) refers to a specific type of recurrence relation. However  \"\"difference equation\"\" is frequently used to refer to any recurrence relation.\"", "AK"), 
("846", NULL, "", NULL), 
("144", "SYS390", "", NULL), 
("849", NULL, "", NULL), 
("524", "COS350", "", NULL), 
...
("679", "COS250", "", NULL), 
("333", "COS264", "", NULL), 
("345", "COS264", "Pieces of data transmitted across the web stored in a users browser that can be referenced by the web page they oriented from to access a users previous activity or data.", "AS"), 
("68", "SYS352", "", NULL), 
("973", "COS284", "Re-associates the current thread with a new program.", "SRW"), 
("1012", NULL, "\"In computing  a regular expression provides a concise and flexible means to \"\"match\"\" (specify and recognize) strings of text  such as particular characters  words  or patterns of characters. Common abbreviations for \"\"regular expression\"\" include regex and regexp.\"", "AK"), 
("343", "COS264", "", NULL), 
("59", "SYS310", "", NULL), 
("424", "COS331", "", NULL), 
("1040", NULL, "", NULL), 
...
("1360", NULL, "", NULL), 
("1385", NULL, "", NULL), 
("1443", NULL, "It is a 2D matrix that can be applied to an image to create some kind of filter. See here: http://www.aishack.in/2010/08/image-convolution-examples/", "SRW"), 
("1460", NULL, "", NULL), 
("1198", "SYS392", "", NULL), 
("1559", NULL, "In computer science  an abstract data type (ADT) is a mathematical model for a certain class of data structures that have similar behavior; or for certain data types of one or more programming languages that have similar semantics. An abstract data type is defined indirectly  only by the operations that may be performed on it and by mathematical constraints on the effects (and possibly cost) of those operations.", "AK"), 
("1399", "COS381", "", NULL), 
("1575", NULL, "", NULL), 
("1587", NULL, "", NULL), 
("1321", "COS121", "", NULL), 
...
("619", "COS381", "", NULL), 
("835", NULL, "", NULL), 
("870", NULL, "In computer science  an abstract data type (ADT) is a mathematical model for a certain class of data structures that have similar behavior; or for certain data types of one or more programming languages that have similar semantics. An abstract data type is defined indirectly  only by the operations that may be performed on it and by mathematical constraints on the effects (and possibly cost) of those operations.", "AK"), 
("633", "COS381", "", NULL), 
("1", "IAS330", "", NULL), 
("904", NULL, "", NULL), 
("923", NULL, "", NULL), 
...
("1151", "COS120", "Loops  conditionals  commands in the right order", "AAC"), 
("1314", "SYS352", "", NULL), 
("1593", "COS382", "", NULL), 
("1210", "COS265", "O(n^2)?", NULL), 
("1715", NULL, "\"Purpose of hash tables is It can be used to compare large amounts of data. You create the hashes for the data  store the hashes and later if you want to compare the data  you just compare the hashes.  Hashes can be used to index data. They can be used in hash tables to point to the correct row. If you want to quickly find a record  you calculate the hash of the data and directly go to the record where the corresponding hash record is pointing to. (This assumes that you have a sorted list of hashes that point to the actual records)   They can be used in cryptographic applications like digital signatures.  Hashing can be used to generate seemingly random strings\"", "AAC"), 
("1750", NULL, "", NULL), 
("422", "COS331", "", NULL), 
("439", "COS331", "", NULL), 
("232", "COS240", "Controls are the different objects that you can drop into a visual basic application.For example  in an application you could put a button control.", "AAC"), 
("336", "COS264", "Using the Java Virtual Machine which must be installed.", "AAC"), 
("285", "COS250", "", NULL), 
("889", NULL, "", NULL), 
("903", NULL, "", NULL), 
("909", NULL, "", NULL), 
...
("538", "COS350", "", NULL), 
("576", "COS351", "", NULL), 
("1025", NULL, "A greedy algorithm is an algorithm that follows the problem solving heuristic of making the locally optimal choice at each stage with the hope of finding a global optimum. In many problems  a greedy strategy does not in general produce an optimal solution  but nonetheless a greedy heuristic may yield locally optimal solutions that approximate a global optimal solution in a reasonable time.", "AK"), 
("433", "COS331", "", NULL), 
("1053", "COS280", "Strong AI is the idea that artificial intelligence can match or surpass human intelligence. Weak AI merely emulates the behaviour of human intelligence.", "AD"), 
("975", "COS284", "", NULL), 
("1058", NULL, "", NULL), 
("1060", "SYS411", "", NULL), 
("1072", NULL, "", NULL), 
("1073", "COS265", "Use a queue when you want the first item added to be the first item removed. Use a stack when you want the most recent item added to be the first item removed.", "AD"), 
("299", "MAT215", "In mathematics  the pigeonhole principle states that if n items are put into m pigeonholes with n > m  then at least one pigeonhole must contain more than one item.", "AD"), 
("1077", NULL, "", NULL), 
("14", "SYS200", "", NULL), 
("1093", NULL, "", NULL), 
("1097", "SYS290", "An ERD is comprised of entities and relationships  hence entity relationship diagram.  Entities are basically the tables in your database  and relationships are the connectors between entities and formed via primary and foreign keys. ", "AK"), 
("1183", "COS284", "", NULL), 
("1221", "COS265", "\"In mathematics  a recurrence relation is an equation that recursively defines a sequence  once one or more initial terms are given: each further term of the sequence is defined as a function of the preceding terms.\nThe term difference equation sometimes (and for the purposes of this article) refers to a specific type of recurrence relation. However  \"\"difference equation\"\" is frequently used to refer to any recurrence relation.\"", "AK"), 
("1278", "ENP352", "", NULL), 
("1274", "ENP321", "", NULL), 
("1352", NULL, "", NULL), 
("1368", NULL, "", NULL), 
...
("1535", "ENP331", "", NULL), 
("1541", NULL, "", NULL), 
("1558", NULL, "\"In computing  a regular expression provides a concise and flexible means to \"\"match\"\" (specify and recognize) strings of text  such as particular characters  words  or patterns of characters. Common abbreviations for \"\"regular expression\"\" include regex and regexp.\"", "AK"), 
("1570", NULL, "", NULL), 
("1582", NULL, "", NULL), 
("1618", NULL, "", NULL), 
("1237", "SYS352", "", NULL), 
("253", "COS250", "\"whose value refers directly to (or \"\"points to\"\") another value stored elsewhere in the computer memory using its address\"", "AAC"), 
("1287", "COS331", "", NULL), 
("421", "COS331", "", NULL), 
("541", "COS350", "", NULL), 
("249", "COS250", "", NULL), 
...
("1372", "COS350", "", NULL), 
("1113", "COS121", "", NULL), 
("1206", "COS121", "In computer science  an abstract data type (ADT) is a mathematical model for a certain class of data structures that have similar behavior; or for certain data types of one or more programming languages that have similar semantics. An abstract data type is defined indirectly  only by the operations that may be performed on it and by mathematical constraints on the effects (and possibly cost) of those operations.", "AK"), 
("1697", NULL, "", NULL), 
("902", NULL, "", NULL), 
("940", NULL, "", NULL), 
("981", NULL, "", NULL), 
("698", "MAT215", "", NULL), 
("993", NULL, "", NULL), 
("22", "SYS290", "An ERD is an Entity Relationship diagram and it is used to model a database visually. An ERD is comprised of entities and relationships  hence entity relationship diagram.  Entities are basically the tables in your database  and relationships are the connectors between entities and formed via primary and foreign keys. ", "AK"), 
("109", "SYS390", "", NULL), 
("1071", NULL, "", NULL), 
("1074", NULL, "In computer science  functional programming is a programming paradigm that treats computation as the evaluation of mathematical functions and avoids state and mutable data. It emphasizes the application of functions  in contrast to the imperative programming style  which emphasizes changes in state.[1] Functional programming has its roots in lambda calculus  a formal system developed in the 1930s to investigate function definition  function application  and recursion. Many functional programming languages can be viewed as elaborations on the lambda calculus.[1] Javascript is an example of a functional language. prominent functional programming languages such as Common Lisp  Scheme [2][3][4][5] ISLISP  JavaScript  Clojure  Racket [6] Erlang [7][8][9] OCaml [10][11] Haskell [12][13] Scala[14] and F#[15][16] ", "AK"), 
("1082", NULL, "", NULL), 
("1085", NULL, "\"In computing  a regular expression provides a concise and flexible means to \"\"match\"\" (specify and recognize) strings of text  such as particular characters  words  or patterns of characters. Common abbreviations for \"\"regular expression\"\" include regex and regexp.\"", "AK"), 
("52", "SYS310", "", NULL), 
("974", "COS284", "", NULL), 
("1107", NULL, "", NULL), 
("1320", NULL, "", NULL), 
...
("1347", "COS425", "", NULL), 
("814", NULL, "\"In computing  a regular expression provides a concise and flexible means to \"\"match\"\" (specify and recognize) strings of text  such as particular characters  words  or patterns of characters. Common abbreviations for \"\"regular expression\"\" include regex and regexp.\"", "AK"), 
("815", NULL, "", NULL), 
("820", NULL, "", NULL), 
("332", "COS264", "", NULL), 
("319", "COS252", "", NULL), 
...
("1091", NULL, "", NULL), 
("1104", NULL, "", NULL), 
("1386", "SYS310", "A clear vision and goal  patience and a long term view  taking calculated risks  commitment to continuous improvement  successful sites have good advisors  make decisions quickly and change their minds slowly  consumer is king  embrace technology and change  be fair and honest with customers and suppliers  no such thing as easy  money.", NULL), 
("1453", NULL, "", NULL), 
("1497", NULL, "", NULL), 
...
("1545", "COS284", "", NULL), 
("344", "COS264", "Extensible Markup Language. ", NULL), 
("1209", "COS265", "", NULL), 
("1324", "COS340", "", NULL), 
("242", "COS250", "", NULL), 
("1646", NULL, "In computer science  an abstract data type (ADT) is a mathematical model for a certain class of data structures that have similar behavior; or for certain data types of one or more programming languages that have similar semantics. An abstract data type is defined indirectly  only by the operations that may be performed on it and by mathematical constraints on the effects (and possibly cost) of those operations.", "AK"), 
("1743", NULL, "", NULL), 
("1758", NULL, "", NULL), 
("813", NULL, "In computer science  an abstract data type (ADT) is a mathematical model for a certain class of data structures that have similar behavior; or for certain data types of one or more programming languages that have similar semantics. An abstract data type is defined indirectly  only by the operations that may be performed on it and by mathematical constraints on the effects (and possibly cost) of those operations.", "AK"), 
("829", NULL, "", NULL), 
("95", "SYS352", "", NULL), 
("857", NULL, "A greedy algorithm is an algorithm that follows the problem solving heuristic of making the locally optimal choice at each stage with the hope of finding a global optimum. In many problems  a greedy strategy does not in general produce an optimal solution  but nonetheless a greedy heuristic may yield locally optimal solutions that approximate a global optimal solution in a reasonable time.", "AK"), 
("873", NULL, "", NULL), 
("54", "SYS310", "", NULL), 
("877", NULL, "", NULL), 
("885", NULL, "Dijkstras algorithm  conceived by Dutch computer scientist Edsger Dijkstra in 1956 and published in 1959 [1][2] is a graph search algorithm that solves the single-source shortest path problem for a graph with nonnegative edge path costs  producing a shortest path tree. This algorithm is often used in routing and as a subroutine in other graph algorithms.", "AK"), 
("900", NULL, "A greedy algorithm is an algorithm that follows the problem solving heuristic of making the locally optimal choice at each stage with the hope of finding a global optimum. In many problems  a greedy strategy does not in general produce an optimal solution  but nonetheless a greedy heuristic may yield locally optimal solutions that approximate a global optimal solution in a reasonable time.", "AK"), 
("922", NULL, "", NULL), 
("407", "COS320", "", NULL), 
("952", NULL, "", NULL), 
("340", "COS264", "", NULL), 
...
("308", "COS252", "", NULL), 
("259", "COS250", "", NULL), 
("245", "COS250", "In computer science  an abstract data type (ADT) is a mathematical model for a certain class of data structures that have similar behavior; or for certain data types of one or more programming languages that have similar semantics. An abstract data type is defined indirectly  only by the operations that may be performed on it and by mathematical constraints on the effects (and possibly cost) of those operations.", "AK"), 
("266", "COS250", "", NULL), 
("1007", NULL, "\"In computing  a regular expression provides a concise and flexible means to \"\"match\"\" (specify and recognize) strings of text  such as particular characters  words  or patterns of characters. Common abbreviations for \"\"regular expression\"\" include regex and regexp.\"", "AK"), 
("1236", "MAT215", "", NULL), 
("1344", NULL, "", NULL), 
("1465", NULL, "", NULL), 
("1212", "COS284", "", NULL), 
...
("431", "COS331", "", NULL), 
("1306", "COS284", "", NULL), 
("1435", "COS284", "Re-associates the current process with a different program.", "SRW"), 
("1421", "COS382", "", NULL), 
("1744", NULL, "", NULL), 
("1745", NULL, "", NULL), 
("268", "COS250", "", NULL), 
...
("1683", NULL, "", NULL), 
("942", NULL, "", NULL), 
("943", "COS265", "\"In mathematics  a recurrence relation is an equation that recursively defines a sequence  once one or more initial terms are given: each further term of the sequence is defined as a function of the preceding terms.\nThe term difference equation sometimes (and for the purposes of this article) refers to a specific type of recurrence relation. However  \"\"difference equation\"\" is frequently used to refer to any recurrence relation.\"", "AK"), 
("420", "COS331", "", NULL), 
("1002", NULL, "", NULL), 
("1217", NULL, "", NULL), 
("1281", "MAT215", "", NULL), 
...
("1530", "ENP321", "", NULL), 
("1571", NULL, "", NULL), 
("1623", NULL, "\"Unified Modeling Language (UML) is a standardized general-purpose modeling language in the field of object-oriented software engineering. The standard is managed  and was created  by the Object Management Group. It was first added to the list of OMG adopted technologies in 1997  and has since become the industry standard for modeling software-intensive systems.\nUML includes a set of graphic notation techniques to create visual models of object-oriented software-intensive systems.", "AK"), 
("1652", NULL, "", NULL), 
("1756", NULL, "", NULL), 
("379", "COS320", "Shes a woman  why bother trying??", NULL), 
("1494", "COS265", "An object is a thing. IN java  you create an object by declaring the data type  object name and creating a new one. Example: Date myBirthday = new Date(9/25/1991); ", NULL), 
("1499", "COS264", "Regular expressions is a way to match strings. To match a SSN  you would do ^\d{3}-\d{2}-\d{4}$. ", NULL), 
("1573", NULL, "It is a bad exmplae of recursion  because each time the function is executed on a number greater than one  it makes two function calls to itself  leading to an exponential number of calls (and thus exponential time complexity)", NULL), 
("1664", NULL, "", NULL), 
("1748", NULL, "", NULL), 
("840", NULL, "In computer science  a heap is a specialized tree-based data structure that satisfies the heap property: If A is a parent node of B then key(A) is ordered with respect to key(B) with the same ordering applying across the heap. In a max heap the keys of parent nodes are always greater than or equal to those of the children and the highest key exists in the root node. In a min heap the keys of parent nodes are always less than or equal to those of the children and the root node has the lowest key.", "AK"), 
("610", "COS381", "", NULL), 
("908", NULL, "", NULL), 
("1130", "COS350", "", NULL), 
("1284", NULL, "", NULL), 
...
("872", NULL, "", NULL), 
("874", "COS265", "A Java virtual machine (JVM) is a virtual machine that can execute Java bytecode. It is the code execution component of the Java software platform.", "AK"), 
("896", NULL, "", NULL), 
("912", NULL, "", NULL), 
("915", NULL, "", NULL), 
("385", "COS320", "", NULL), 
...
("1548", NULL, "lick it", NULL), 
("1583", NULL, "", NULL), 
("271", "COS250", "Pre-order  post-order  and in-order.", "SRW"), 
("133", "SYS390", "", NULL), 
("1650", NULL, "", NULL), 
("18", "SYS200", "", NULL), 
("278", "COS250", "", NULL), 
...
("1126", "COS331", "", NULL), 
("239", "COS240", "", NULL), 
("346", "COS264", "The Common Gateway Interface (CGI) is a standard method for web server software to delegate the generation of web content to executable files. Such files are known as CGI scripts; they are programs  often stand-alone applications  usually written in a scripting language.", "AK"), 
("1686", "COS265", "", NULL), 
("1008", NULL, "Use a recursive function to traverse the tree in the desired order. The complexity is O(n) (n being the number of nodes in the tree)", "SRW"), 
("1411", NULL, "", NULL), 
("1651", "COS341", "An index can be created on one or more fields  which means that the order of entries in the database sorted by those fields is stored. This makes for quick retrieval if one needs to search through the table by that field. The cost is that the initial time to set up that index takes time (and slightly more memory than the actual database)", "SRW"), 
("115", "SYS390", "", NULL), 
("1095", NULL, "", NULL), 
("1395", "COS265", "", NULL), 
("1625", "COS265", "", NULL), 
("1633", NULL, "", NULL), 
("1636", NULL, "It will take 4 times as long (2^2)", "SRW"), 
("1291", "COS381", "", NULL), 
("816", NULL, "", NULL), 
("695", "COS252", "\"In mathematics  a recurrence relation is an equation that recursively defines a sequence  once one or more initial terms are given: each further term of the sequence is defined as a function of the preceding terms.\n The term difference equation sometimes (and for the purposes of this article) refers to a specific type of recurrence relation. However  \"\"difference equation\"\" is frequently used to refer to any recurrence relation.\"", "AK"), 
("426", "COS331", "", NULL), 
("947", NULL, "", NULL), 
("1006", "COS121", "To traverse  you could write a recursive function that calls itself on each leaf node.", "SRW"), 
("1005", "SYS390", "\"Situation Appraisal is a formal method whereby a manager  or an individual  sets time aside to look at current and future realities. \n1. Identify Concerns 2. Set Priority 3. Plan Next Steps 4. Plan involvement\nIts purpose in system development methodology is to access a situation so that you can make decisions based a firm understanding of the situation. \"", "AK"), 
("1018", NULL, "In computer science  functional programming is a programming paradigm that treats computation as the evaluation of mathematical functions and avoids state and mutable data. It emphasizes the application of functions  in contrast to the imperative programming style  which emphasizes changes in state.[1] Functional programming has its roots in lambda calculus  a formal system developed in the 1930s to investigate function definition  function application  and recursion. Many functional programming languages can be viewed as elaborations on the lambda calculus.[1] Javascript is an example of a functional language. prominent functional programming languages such as Common Lisp  Scheme [2][3][4][5] ISLISP  JavaScript  Clojure  Racket [6] Erlang [7][8][9] OCaml [10][11] Haskell [12][13] Scala[14] and F#[15][16] ", "AK"), 
("1204", NULL, "", NULL), 
("1377", NULL, "", NULL), 
("1410", NULL, "", NULL), 
("1476", NULL, "", NULL), 
("1553", "COS252", "\"In mathematics  a recurrence relation is an equation that recursively defines a sequence  once one or more initial terms are given: each further term of the sequence is defined as a function of the preceding terms.\n The term difference equation sometimes (and for the purposes of this article) refers to a specific type of recurrence relation. However  \"\"difference equation\"\" is frequently used to refer to any recurrence relation.\"", "AK"), 
("1568", NULL, "", NULL), 
("1577", NULL, "", NULL), 
("1196", "MAT215", "", NULL), 
("1759", NULL, "", NULL), 
("936", NULL, "Exponential complexity is when an algorithms complexity  as n increases  grows exponentially. ", "AAC"), 
("1027", NULL, "", NULL), 
("1054", "MAT215", "\"De Morgans laws are a pair of transformation rules that are both valid rules of inference. The rules allow the expression of conjunctions and disjunctions purely in terms of each other via negation.   EXAMPLE: ~(P ^ Q) = (~P) v (~Q)\nThe rules can be expressed in English as:\nThe negation of a conjunction is the disjunction of the negations.\nThe negation of a disjunction is the conjunction of the negations.\"", "AK"), 
("156", "SYS390", "The database relational model does not offer direct support to many-to-many relationships. An associative entity then joins two or more entities together. It has the primary keys of the adjoining tables  but may also contain its own unique identifier and other information about the relationship.", "AAC"), 
...
("1602", "COS121", "\"void swapByRef(int * a  int * b) {    int swap;\n swap= * a;\n *a=*b;\n     *b=swap;\n}\"", "SRW"), 
("1461", "SYS310", "If youre taking credit card information  then you need to have encrypted backup  service monitoring  and response from your web host company. You also need two factor authentication. You need a redundant firewall protection and web application protection to protect against SQL injections and cross-site scripting attacks.", "AAC"), 
("1463", NULL, "There are some numbers arranged in a rectangular form.", "SRW"), 
("1500", "COS350", "", NULL), 
("1596", "MAT215", "RSA is an algorithm for public-key cryptography that is based on the presumed difficulty of factoring large integers  the factoring problem. RSA stands for Ron Rivest  Adi Shamir and Leonard Adleman  who first publicly described it in 1977. Clifford Cocks  an English mathematician  had developed an equivalent system in 1973  but it was classified until 1997. A user of RSA creates and then publishes the product of two large prime numbers  along with an auxiliary value  as their public key. The prime factors must be kept secret. Anyone can use the public key to encrypt a message  but with currently published methods  if the public key is large enough  only someone with knowledge of the prime factors can feasibly decode the message. Whether breaking RSA encryption is as hard as factoring is an open question known as the RSA problem.", "AK"), 
("1186", "COS320", "", NULL), 
("1711", "SYS394", "\"Habit 1: Be Proactive\nTake initiative in life by realizing that your decisions (and how they align with lifes principles) are the primary determining factor for effectiveness in your life. Take responsibility for your choices and the consequences that follow.\nHabit 2: Begin with the End in Mind\nSelf-discover and clarify your deeply important character values and life goals. Envision the ideal characteristics for each of your various roles and relationships in life. Create a mission statement.\nHabit 3: Put First Things First\nPrioritize  plan  and execute your weeks tasks based on importance rather than urgency. Evaluate whether your efforts exemplify your desired character values  propel you toward goals  and enrich the roles and relationships that were elaborated in Habit 2.\nHabit 4: Think Win-Win\nGenuinely strive for mutually beneficial solutions or agreements in your relationships. Value and respect people by understanding a \"\"win\"\" for all is ultimately a better long-term resolution than if only one person in the situation had gotten his way.Habit 5: Seek First to Understand  Then to be Understood\nUse empathic listening to be genuinely influenced by a person  which compels them to reciprocate the listening and take an open mind to being influenced by you. This creates an atmosphere of caring  respect  and positive problem solving.\nHabit 6: Synergize\nCombine the strengths of people through positive teamwork  so as to achieve goals no one person could have done alone.\nHabit 7: Sharpen the Saw\nBalance and renew your resources  energy  and health to create a sustainable  long-term  effective lifestyle. It primarily emphasizes exercise for physical renewal  prayer (meditation  yoga  etc.) and good reading for mental renewal. It also mentions service to society for spiritual renewal. (http://en.wikipedia.org/wiki/The_Seven_Habits_of_Highly_Effective_People)\"", "SRW"), 
("988", "COS265", "\"A pointer can be re-assigned any number of times while a reference can not be reassigned after initialization.\nA pointer can point to NULL while reference can never point to NULL\nYou cant take the address of a reference like you can with pointers. Reference variables are safer.\"", "AAC"), 
...
("1228", "COS265", "", NULL), 
("1330", NULL, "", NULL), 
("1512", NULL, "Yes  it is an array. ", "AAC"), 
("313", "COS252", "", NULL), 
("899", NULL, "", NULL), 
("901", NULL, "", NULL), 
("320", "COS252", "", NULL), 
("380", "COS320", "Not as much as Ada Lovelace. Charles Babbage was an English mathematician  philosopher  inventor and mechanical engineer who originated the concept of a programmable computer. ", NULL), 
("948", NULL, "", NULL), 
...
("1547", NULL, "", NULL), 
("1564", NULL, "", NULL), 
("1617", "COS320", "\"NP refers to \"\"nondeterministic polynomial time.\"\"  So to say a problem is NP means that the answer is <b>verifiable</b> in polynomial time by a deterministic Turing machine.  (Essentially this means that any proposed solution for the (NP) problem can be proven incorrect or correct in a reasonable amount of time.)  For more on NP  P  and NP-complete see wikipedia <a href=\"\"http://en.wikipedia.org/wiki/NP_(complexity)\"\">here</a>.\"", "MJW"), 
("982", NULL, "1. Connection: TCP is connection -oriented. UDP is connectionless. You dont know if itll get there. 2. Order: With TCP data packets will arrive in the correct order. UDP there is no order. 3. Weight: TCP Is more heavy weight since packets packets may arrive in the wrong order and resent requests have to be sent. UDP doesnt have a connection or order  so its a lot quicker. 4. Streaming: Data is read as a strema with TCP. There may be multiple packets per read call. UDP is more of a datagram --  one packet per one read call.", NULL), 
...
("1741", "COS380", "", NULL), 
("67", "SYS310", "“Push” Technology allows you to become an integral part of your customers daily lives by enforcing your brands and services directly to them every day. Key messages and personalized information that they have requested  and critical information can be delivered to their desktop  screen saver  any wireless device  mail account and more. “Push” amplifies and extends your current Web presence while providing new and valuable services. Your customer is directed back to your Web site for more in-depth information. This technology eliminates the need to wait for customers to visit your site  instead  allowing an organisation to take their business to their customer base.", NULL), 
...
("1546", NULL, "", NULL), 
("1757", "MAT215", "", NULL), 
("129", "SYS390", " The quality of products and processes is the responsibility of everyone who is involved with the creation or consumption of the products or services offered by an organization", NULL), 
("890", NULL, "", NULL), 
("944", "COS343", "", NULL), 
("476", "COS340", "", NULL), 
("999", "SYS214", " A model of human movement primarily used in human–computer interaction and ergonomics that predicts that the time required to rapidly move to a target area is a function of the distance to the target and the size of the target.", NULL), 
("1010", "COS280", "In computer science  functional programming is a programming paradigm that treats computation as the evaluation of mathematical functions and avoids state and mutable data. It emphasizes the application of functions  in contrast to the imperative programming style  which emphasizes changes in state.[1] Functional programming has its roots in lambda calculus  a formal system developed in the 1930s to investigate function definition  function application  and recursion. Many functional programming languages can be viewed as elaborations on the lambda calculus.[1] Javascript is an example of a functional language. prominent functional programming languages such as Common Lisp  Scheme [2][3][4][5] ISLISP  JavaScript  Clojure  Racket [6] Erlang [7][8][9] OCaml [10][11] Haskell [12][13] Scala[14] and F#[15][16] ", "AK"), 
("24", "SYS200", "An analyst should normalize the data base to eliminate data redundancy  increase efficiency  and to minimize dependency", NULL), 
("624", "COS381", "", NULL), 
("861", "COS265", "Very carefully...Just kidding. You want to see what the complexity would be for N = 0  and then for n = 1  and then reason for N > 1.", NULL), 
("869", "COS320", "", NULL), 
("161", "SYS390", "", NULL), 
("1214", "MAT215", "", NULL), 
("27", "SYS200", "", NULL), 
...
("1742", NULL, "It is passed using GET  which is part of REST.", NULL), 
("1749", NULL, "Still arent engineers.", NULL), 
("456", "COS340", "\"<p><b>Short Version:<b><table><tr><th>Level</th><th>Name</th></tr><tr><td>1</td><td>Initial</td></tr><tr><td>2</td><td>Managed</td></tr><tr><td>3</td><td>Defined</td></tr><tr><td>4</td><td>Quantitatively Managed</td></tr><tr><td>5</td><td>Optimized</td></tr></table></p><br />    <p><b>Longer Version:</b></p>    <p><h4>Level 1--Initial</h4><ul><li>Processes are ad-hoc  chaotic<ul><li>No stable environment to support processes\n</li></ul></li><li>Success depends on competence  heroics</li><li>Often produces products that work<ul><li>frequently exceed budget and schedule</li></ul></li><li>Tend to over-commit</li><li>Abandon process in time of crisis</li><li>Unable to repeat success</li></ul></p>    <p><h4>Level 2--Managed</h4><ul><li>Plan  execute processes according to policy</li><li>Skilled staff with adequate resources</li><li>Involve relevant stakeholders</li><li>Documented  monitored  controlled  reviewed</li><li>Processes retained during times of stress</li><li>Improvement over Level 1</li><li><ul><li>Status visible to management (e.g.  milestones)</li><li>Commitments established and revised</li><li>Work appropriately controlled</li></ul></li></ul></p>    <p><h4>Level 3--Defined</h4><ul><li>Processes well characterized  understood</li><li><ul><li>Standards  procedures  tools  methods exist</li></ul></li><li>Improved over time</li><li>Consistent across the organization</li><li><ul>Organizational standards tailored to project</ul></li><li>Improvement over Level 2</li><li><ul><li>Processes described rigorously</li><li>Purpose  inputs  outputs  activities  roles  metrics  etc.</li><li>managed proactively</li></ul></li></ul></p>    <p><h4>Level 4--Quantitatively Managed</h4><ul><li>Quantitative objectives for process performance</li><li><ul><li>Used as criteria for managing projects</li></ul></li><li>Quality  process understood statistically</li><li><ul>Specific measures collected  analyzed</li><li>Create baselines and set objectives</li></ul></li><li>Improvement over Level 3</li><li><ul><li>predictability of process performance</li></ul></li></ul></p>    <p><h4>Level 5--Optimizing</h4><ul><li>Continuous process improvement</li><li><ul>Based on quantitative understanding</ul></li><li>Incremental  innovative technological improvements</li><li>Clear performance objectives and measures</li><li>Improvement over Level 4</li><li><ul><li>Improving performance organization-wide</li><li>Use data from multiple projects</li></ul></li></ul></p>\"", "MJW"), 
("907", NULL, "WE ARENT ENGINEERS.", NULL), 
("994", "COS311", "\"Deontological ethics or deontology (from Greek deon  \"\"obligation  duty\"\"; and -logia) is the normative ethical position that judges the morality of an action based on the actions adherence to a rule or rules. It is sometimes described as \"\"duty\"\" or \"\"obligation\"\" or \"\"rule\"\" -based ethics  because rules \"\"bind you to your duty\"\".\"", "AK"), 
("1063", "COS425", "\"NURBS models are created by mathematical formulas. You will usually have more control over curves than you will with polygon models. Polygonal models tend to require a lot more memory because you are storing actual coordinates rather than the UV coordinates of the NURBS models. Polygonal models work better for more \"\"straight edge\"\" models.\"", NULL), 
("1068", "COS311", "\"Kantian ethics are deontological  revolving entirely around duty rather than emotions or end goals. All actions are performed in accordance with some underlying maxim or principle  which are deeply different from each other; it is according to this that the moral worth of any action is judged. Kants ethics are founded on his view of rationality as the ultimate good and his belief that all people are fundamentally rational beings. This led to the most important part of Kants ethics  the formulation of the Categorical Imperative  which is the criterion for whether a maxim is good or bad. The Formulation Rule of Kantianism:\nAct only according to that maxim by which you can at the same time will that it would become a universal law.\nAct so that you always treat others as an end  and never as a means to an end only.\"", "AK"), 
("174", "SYS394", "Determining what needs to happen in a project  determining dependencies  attach persons responsible to tasks  and track progress.", NULL), 
("240", "COS265", " the breaking down of a system to gain insight into its compositional sub-systems. In a top-down approach an overview of the system is formulated  specifying but not detailing any first-level subsystems. Each subsystem is then refined in yet greater detail  sometimes in many additional subsystem levels  until the entire specification is reduced to base elements.", "AAC"), 
("277", "COS265", "<p><b>One Answer:</b>The most efficient sort algorithm is an insertion sort when the input is already sorted  then the time complexity is O(n) where n is the quantity of the input.</p>               <p>This question is actually a little deeper than it first appears.  Each algorithm has a big-o notation that is good at describing normal algorithmic behavior  but this big-o notation does not hold true for every situation i.e. a small input set.  Each algorithm also has a best and worse case scenario.  The best case that can be held with normal algorithms is linear time or O(n) in big-o notation  because each element must be examined once before the input set can be declared sorted.</p><p><b>The following is a list of some common sorting algorithms and their efficiencies.</b><ul><li><b>Bubble Sort</b>[Best: O(n)  Worst: O(n^2)]</li><li><b>Selection Sort</b>[Best/Worst: O(n^2)]</li><li><b>Insertion Sort</b>[Best: O(n)  Worst: O(n^2)]</li><li><b>Quicksort</b>[Best: O(n lg n)  Avg: O(n lg n)  Worst: O(n^2)]</li><li><b>Heapsort</b>[Best/Avg/Worst: O(n lg n)]</li><li><b>Counting Sort</b>[Best/Avg/Worst: O(n)]<small><i>Counting Sort requires heavily structured input  look at it further before considering it the best because of its big-o notation.</i></small></li><li><b>Radix Sort</b>[Best/Avg/Worst: O(n)]<small><i>Radix & counting sort are fast  but require structured data  external memory and do not have the caching benefits of quicksort.</i><small></li><ul></p>", "MJW"), 
("1200", "COS320", "", NULL), 
("1203", "COS311", "\"Deontological ethics or deontology (from Greek deon  \"\"obligation  duty\"\"; and -logia) is the normative ethical position that judges the morality of an action based on the actions adherence to a rule or rules. It is sometimes described as \"\"duty\"\" or \"\"obligation\"\" or \"\"rule\"\" -based ethics  because rules \"\"bind you to your duty\"\".\"", "AK"), 
("1371", "COS331", "", NULL), 
("1382", "COS311", "\"Utilitarianism is a theory in normative ethics holding that the proper course of action is the one that maximizes overall happiness. It is now generally taken to be a form of consequentialism  although when Anscome first introduced that term it was to distinguish between \"\"old-fashioned Utilitarianism\"\" and consequentialism.[1] According to utilitarianism the moral worth of an action is determined only by its resulting outcome although there is debate over how much consideration should be given to actual consequences  foreseen consequences and intended consequences. Two influential contributors to this theory are Jeremy Bentham and John Stuart Mill. In A Fragment on Government Bentham says ‘it is the greatest happiness of the greatest number that is the measure of right and wrong’ and describes this as a fundamental axiom. In An Introduction to the Principles of Morals and Legislation he talks of ‘the principle of utility’ but later prefers “the greatest happiness principle\"\".[2][3]\nUtilitarianism can be characterized as a quantitative and reductionist approach to ethics. It is a type of naturalism.[4] It can be contrasted with deontological ethics [5] which does not regard the consequences of an act as a determinant of its moral worth; virtue ethics [6] which primarily focuses on acts and habits leading to happiness; pragmatic ethics; as well as with ethical egoism and other varieties of consequentialism.[7] http://en.wikipedia.org/wiki/Utilitarianism\"", "SRW"), 
("1459", "COS265", "A special notation used in performance measurements of algorithms.  This special notation is used to measure how an algorithm reacts to changes in input size.  (Dr. Toll often refers to this when discussing how an algorithm will react when the input size is doubled.  Basically its looking at the big picture.)", "AAC / MJW"), 
("1380", "COS350", "", NULL), 
("1537", NULL, "", NULL), 
("1598", "COS341", "The existence of multiple copies of some data. For example  two database entries that have overlapping fields  or using a variable to store the same value as another variable unnecessarily", "SRW");